...
Route::get('/error/401', function(){require _CAMINHO_TEMPLATE. "erro401.php";});
Route::get('/error/404', function(){require _CAMINHO_TEMPLATE. "erro404.php";});
Route::get('/404', function(){require _CAMINHO_TEMPLATE. "erro404.php";});
